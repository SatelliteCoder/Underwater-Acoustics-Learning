...
## 一、被动声呐辐射噪声数据集
一维音频wav，声纹分类，适合UUV识别

### 原有数据集（4项）

| 数据集名称 | 开源地址 | 数据类型 | 标注情况 | 用途 | 重要限制说明 |
|---|---|---|---|---|---|
| **QiandaoEar22** | [GitHub](https://github.com/xiaoyangdu22/QiandaoEar22) / [IEEE DataPort](https://ieee-dataport.org/documents/qiandaoear22) | wav音频，3s片段 | ✅片段级单标签；UUV/快艇/游船/货船/背景噪声；附带距离信息 | UUV/船舶水声分类 | ① GitHub仓库只有标签脚本，没有wav音频；② 淡水千岛湖采集；③ 大量UUV片段混合其他船只噪声；④ 仅一款小型UUV |
